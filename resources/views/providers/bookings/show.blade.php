            ...
            <div class="flex-1 min-w-0">
                <div class="mb-6">
                    <div class="flex items-center gap-3 mb-1">
                        <a href="{{ route('provider.bookings.index') }}" class="text-slate-400 hover:text-slate-600">
                    ...
                    <div class="bg-white border border-slate-100 rounded-md shadow-sm p-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm text-slate-600">{{ \Carbon\Carbon::parse($booking->scheduleDate->departure_date)->format('d M, Y') }}</span>
                            </div>
                            <div class="flex justify-between">
