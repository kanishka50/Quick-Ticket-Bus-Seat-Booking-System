...
<body class="bg-surface font-sans text-slate-800">
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <nav class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex space-x-7">
                    <a href="{{ route('home') }}" class="text-sm font-medium text-white transition-colors">Home</a>
    ...
    <section class="relative overflow-hidden bg-slate-900">
        ...
        <div class="absolute inset-0">
            <img src="{{ asset('storage/images/hero-bg1.png') }}" alt="" class="w-full h-full object-cover">
        ...
        <div class="relative container mx-auto px-4 max-w-7xl py-28 md:py-36">
            <div class="max-w-2xl">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('pages.about') }}" class="px-6 py-3 border border-slate-500 text-slate-300 font-medium rounded-md hover:bg-white/5 transition-all text-sm">
                        Learn More
                    </a>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group">
                    <div class="h-44 bg-slate-200 overflow-hidden">
                        <img src="{{ asset('storage/images/colombo-kandy.jpg') }}" alt="Colombo to Kandy" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-5">
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group">
                    <div class="h-44 bg-slate-200 overflow-hidden">
                        <img src="{{ asset('storage/images/colombo-galle.jpg') }}" alt="Colombo to Galle" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center text-sm font-semibold text-slate-900">
                ...
                <div class="bg-white rounded-lg overflow-hidden border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group">
                    <div class="h-44 bg-slate-200 overflow-hidden">
                        <img src="{{ asset('storage/images/kandy-nuwara-eliya.jpg') }}" alt="Kandy to Nuwara Eliya" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center text-sm font-semibold text-slate-900">
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
                    ...
                    <div class="flex items-center">
                        <div class="w-10 h-10 rounded-md overflow-hidden mr-3 bg-slate-200">
                            <img src="{{ asset('storage/images/rajiv-perera.jpg') }}" alt="Rajiv Perera" class="w-full h-full object-cover">
                        </div>
                        <div>
                ...
                <div class="bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
                    ...
                    <div class="flex items-center">
                        <div class="w-10 h-10 rounded-md overflow-hidden mr-3 bg-slate-200">
                            <img src="{{ asset('storage/images/amali-fernando.jpeg') }}" alt="Amali Fernando" class="w-full h-full object-cover">
                        </div>
                        <div>
                ...
                <div class="bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
                    ...
                    <div class="flex items-center">
                        <div class="w-10 h-10 rounded-md overflow-hidden mr-3 bg-slate-200">
                            <img src="{{ asset('storage/images/mahesh-silva.jpeg') }}" alt="Mahesh Silva" class="w-full h-full object-cover">
                        </div>
                        <div>
    ...
    <section class="py-20 bg-slate-900 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 max-w-7xl text-center relative">
            ...
            <div class="flex justify-center gap-3">
                <a href="{{ route('register') }}" class="px-6 py-3 bg-accent text-slate-900 font-semibold rounded-md hover:bg-accent-dark transition-all text-sm">
                    Sign Up Free
                </a>
    ...
    <footer class="bg-slate-900 border-t border-slate-800 pt-14 pb-8">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        ...
                        <li><a href="{{ route('pages.about') }}" class="text-sm text-slate-400 hover:text-white transition-colors">About Us</a></li>
                        <li><a href="{{ route('pages.contact') }}" class="text-sm text-slate-400 hover:text-white transition-colors">Contact Us</a></li>
                    </ul>
                </div>
                <div>
                    <h3 class="text-sm font-semibold text-white uppercase tracking-wider mb-4">Support</h3>
                    <ul class="space-y-2.5">
                        <li><a href="{{ route('pages.terms') }}" class="text-sm text-slate-400 hover:text-white transition-colors">Terms & Conditions</a></li>
                        <li><a href="{{ route('pages.privacy') }}" class="text-sm text-slate-400 hover:text-white transition-colors">Privacy Policy</a></li>
                        <li><a href="{{ route('pages.contact') }}" class="text-sm text-slate-400 hover:text-white transition-colors">Help Center</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="border-t border-slate-800 pt-6 text-center">
                <p class="text-sm text-slate-500">&copy; {{ date('Y') }} QuickTicket. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
