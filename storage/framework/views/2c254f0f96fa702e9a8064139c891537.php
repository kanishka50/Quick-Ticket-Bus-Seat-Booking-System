        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                <div class="mb-6">
                    ...
                    <p class="text-sm text-slate-500 mt-1">Bookings, approvals, and system updates</p>
                </div>
                ...
                <div class="bg-white border border-slate-100 rounded-md shadow-sm overflow-hidden">
                    <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                        ...
                        <?php if($notifications->contains(fn($n) => !$n->is_read)): ?>
                        ...
                        <?php if($notifications->count() > 0): ?>
                            <div class="divide-y divide-slate-100">
                                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="px-5 py-4 notification-item hover:bg-slate-50/50 transition-colors <?php echo e(!$notification->is_read ? 'bg-primary/[0.02]' : ''); ?>" data-id="<?php echo e($notification->id); ?>">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <p class="text-xs text-slate-400 mt-1.5"><?php echo e($notification->created_at->diffForHumans()); ?></p>
                                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/providers/notifications.blade.php ENDPATH**/ ?>