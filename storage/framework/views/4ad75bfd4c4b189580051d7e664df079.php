        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <nav class="flex justify-between items-center py-3.5">
                ...
                <div class="hidden md:flex space-x-7">
                    <a href="<?php echo e(route('home')); ?>" class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Home</a>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php elseif(auth()->user()->user_type == 'driver'): ?>
                            <a href="<?php echo e(route('driver.dashboard')); ?>" class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Dashboard</a>
                        <?php else: ?>
                        ...
                        <div class="relative">
                            ...
                            <div id="profile-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl py-1 z-50 border border-slate-100">
                                ...
                                <div class="py-1">
                                    ...
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                                    ...
                                    <?php elseif(auth()->user()->user_type == 'driver'): ?>
                                    <a href="<?php echo e(route('driver.dashboard')); ?>" class="flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                                        Dashboard
                                    </a>
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
        ...
        <div class="p-6">
            ...
            <div class="flex flex-col space-y-5">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php elseif(auth()->user()->user_type == 'driver'): ?>
                        <a href="<?php echo e(route('driver.dashboard')); ?>" class="text-base font-medium text-slate-300 hover:text-white transition-colors">Dashboard</a>
                    <?php else: ?>
        ...
        <div class="container mx-auto px-4 max-w-7xl py-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <nav class="flex flex-wrap justify-center gap-x-6 gap-y-2">
                    <a href="<?php echo e(route('pages.about')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">About Us</a>
                    <a href="<?php echo e(route('pages.privacy')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Privacy Policy</a>
                    <a href="<?php echo e(route('pages.terms')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Terms of Service</a>
                    <a href="<?php echo e(route('pages.contact')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Contact Us</a>
                </nav>
            ...
            <div class="border-t border-slate-800 mt-6 pt-6 text-center">
                <p class="text-xs text-slate-500">&copy; <?php echo e(date('Y')); ?> QuickTicket. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH H:\bus-ticket-booking-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>