                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <a href="<?php echo e(route('driver.dashboard')); ?>" class="text-slate-400 hover:text-slate-600">
                        ...
                        <form action="<?php echo e(route('driver.trip.end', $assignment)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="bg-white border border-slate-100 rounded-md shadow-sm p-5 mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p class="text-sm font-medium text-slate-900 mt-1"><?php echo e($assignment->scheduleDate->schedule->route->origin->name); ?> → <?php echo e($assignment->scheduleDate->schedule->route->destination->name); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-slate-500 uppercase tracking-wide">Bus</p>
                            <p class="text-sm font-medium text-slate-900 mt-1"><?php echo e($assignment->scheduleDate->schedule->bus->registration_number); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-slate-500 uppercase tracking-wide">Departure</p>
                            <p class="text-sm font-medium text-slate-900 mt-1"><?php echo e(\Carbon\Carbon::parse($assignment->scheduleDate->schedule->departure_time)->format('h:i A')); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-slate-500 uppercase tracking-wide">Date</p>
                            <p class="text-sm font-medium text-slate-900 mt-1"><?php echo e($assignment->scheduleDate->departure_date->format('d M Y')); ?></p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/driver/trip.blade.php ENDPATH**/ ?>