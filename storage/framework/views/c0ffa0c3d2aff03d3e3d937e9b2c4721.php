        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-white border border-slate-100 rounded-md shadow-sm p-6 mb-6">
                    ...
                    <form action="<?php echo e(route('provider.schedules.dates.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <select name="schedule_id" id="schedule_id"
                                    ...
                                    <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($schedule->id); ?>" <?php echo e(old('schedule_id') == $schedule->id ? 'selected' : ''); ?>>
                                            <?php echo e($schedule->route->origin->name); ?> → <?php echo e($schedule->route->destination->name); ?> |
                                            <?php echo e(date('h:i A', strtotime($schedule->departure_time))); ?> -
                                            <?php echo e(date('h:i A', strtotime($schedule->arrival_time))); ?> |
                                            Bus: <?php echo e($schedule->bus->registration_number); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="single-dates-container" class="md:col-span-2">
                                ...
                                <div class="flex gap-2">
                                    <input type="date" id="date-picker" min="<?php echo e(date('Y-m-d')); ?>"
                            ...
                            <div id="date-range-container" class="md:col-span-2 hidden">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="date" id="start-date" min="<?php echo e(date('Y-m-d')); ?>"
                                    ...
                                    <div>
                                        ...
                                        <input type="date" id="end-date" min="<?php echo e(date('Y-m-d')); ?>"
                                            class="w-full px-3 py-2 border border-slate-200 rounded-md text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/providers/schedules/dates.blade.php ENDPATH**/ ?>