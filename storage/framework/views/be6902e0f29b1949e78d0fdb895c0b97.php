        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('provider.schedules.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary hover:bg-primary-dark text-white text-sm font-medium rounded-md transition-colors">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50/50">
                                    <td class="px-5 py-3">
                                        <span class="text-sm font-medium text-slate-900"><?php echo e($schedule->route->origin->name); ?> → <?php echo e($schedule->route->destination->name); ?></span>
                                        <span class="block text-xs text-slate-500"><?php echo e($schedule->route->distance); ?> km</span>
                                    </td>
                                    <td class="px-5 py-3">
                                        <span class="text-sm text-slate-900"><?php echo e($schedule->bus->registration_number); ?></span>
                                        <span class="block text-xs text-slate-500"><?php echo e($schedule->bus->busType->name); ?></span>
                                    </td>
                                    <td class="px-5 py-3">
                                        <span class="text-sm text-slate-600"><?php echo e($schedule->departure_time); ?></span>
                                    </td>
                                    <td class="px-5 py-3">
                                        <span class="text-sm text-slate-600"><?php echo e($schedule->arrival_time); ?></span>
                                    </td>
                                    <td class="px-5 py-3">
                                        <span class="text-sm text-slate-900">LKR <?php echo e(number_format($schedule->price, 2)); ?></span>
                                    </td>
                                    <td class="px-5 py-3">
                                        <span class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-md
                                            <?php if($schedule->status == 'active'): ?> bg-emerald-50 text-emerald-700
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <div class="flex justify-end space-x-2">
                                            <a href="<?php echo e(route('provider.schedules.edit', $schedule)); ?>" class="text-primary hover:text-primary-dark" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                                </svg>
                                            </a>
                                            <button onclick="confirmDelete(<?php echo e($schedule->id); ?>)" class="text-red-500 hover:text-red-700" title="Delete">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" viewBox="0 0 20 20" fill="currentColor">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/providers/schedules/index.blade.php ENDPATH**/ ?>