                    ...
                    <div class="border-b border-slate-100">
                        <nav class="flex -mb-px px-5 space-x-6 overflow-x-auto" aria-label="Tabs">
                            ...
                            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('admin.providers.index', ['status' => $key])); ?>"
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50/50">
                                    ...
                                    <td class="px-5 py-3">
                                        <span class="text-sm text-slate-900"><?php echo e($provider->contact_number); ?></span>
                                        <span class="block text-xs text-slate-500"><?php echo e($provider->user->email); ?></span>
                                    </td>
                                    <td class="px-5 py-3">
                                        <span class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-md
                                            <?php if($provider->status == 'active'): ?> bg-emerald-50 text-emerald-700
                                            <?php elseif($provider->status == 'pending'): ?> bg-amber-50 text-amber-700
                                            <?php elseif($provider->status == 'inactive'): ?> bg-red-50 text-red-700
                                    ...
                                    <td class="px-5 py-3">
                                        <button type="button"
                                                onclick="openStatusModal('<?php echo e($provider->id); ?>', '<?php echo e($provider->company_name); ?>', '<?php echo e($provider->status); ?>')"
                                ...
                                <tr>
                                    <td colspan="4" class="px-5 py-12 text-center">
                                        ...
                                        <p class="text-xs text-slate-500">
                                            <?php if($status !== 'all'): ?>
                                                No <?php echo e($status); ?> providers. <a href="<?php echo e(route('admin.providers.index')); ?>" class="text-primary hover:text-primary-dark">View all providers</a>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/admin/providers/index.blade.php ENDPATH**/ ?>