        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                <div class="mb-6">
                    ...
                    <p class="text-sm text-slate-500 mt-1">All system notifications</p>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/admin/notifications.blade.php ENDPATH**/ ?>