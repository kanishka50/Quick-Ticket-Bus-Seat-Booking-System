            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-gradient-to-r from-primary to-primary-light rounded-md p-6 mb-6">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div>
                            <h1 class="text-xl font-bold text-white">Welcome back, <?php echo e($user->name); ?>!</h1>
                    ...
                    <div class="bg-white border border-slate-100 rounded-md shadow-sm p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xl font-bold text-slate-900 mt-0.5"><?php echo e($totalBookings); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white border border-slate-100 rounded-md shadow-sm p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xl font-bold text-slate-900 mt-0.5"><?php echo e($completedBookings); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white border border-slate-100 rounded-md shadow-sm p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xl font-bold text-slate-900 mt-0.5"><?php echo e($pendingBookings); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="xl:col-span-2">
                        <div class="bg-white border border-slate-100 rounded-md shadow-sm">
                            <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                                ...
                                <a href="<?php echo e(route('user.bookings')); ?>" class="text-xs font-medium text-primary hover:text-primary-dark transition-colors">View all</a>
                            </div>

                            <?php if($upcomingTrips->count() > 0): ?>
                                <div class="divide-y divide-slate-100">
                                    <?php $__currentLoopData = $upcomingTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="px-5 py-4">
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <div class="flex flex-wrap items-center gap-x-4 gap-y-1 mt-1">
                                                            ...
                                                            <span class="text-xs text-slate-500">
                                                                ...
                                                                <?php echo e(\Carbon\Carbon::parse($booking->scheduleDate->schedule->departure_time)->format('h:i A')); ?>

                                                            </span>
                                                            <span class="text-xs text-slate-500">
                                                                <i class="fas fa-user mr-1 text-slate-400"></i>
                                                                <?php echo e($booking->total_passengers); ?> Passenger(s)
                                                            </span>
                                                        </div>
                                                        <div class="flex items-center gap-3 mt-2">
                                                            ...
                                                            <?php endif; ?>
                                                            <span class="text-xs font-medium text-slate-700">LKR <?php echo e(number_format($booking->total_amount, 2)); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="shrink-0">
                                                    <?php if($booking->payment_status == 'pending' && $booking->booking_status == 'pending'): ?>
                                                        <a href="<?php echo e(route('payment.show', $booking->id)); ?>" class="inline-flex items-center px-3 py-1.5 bg-primary text-white text-xs font-medium rounded-md hover:bg-primary-dark transition-colors">
                                                            Pay Now
                                                        </a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('bookings.show', $booking->id)); ?>" class="inline-flex items-center px-3 py-1.5 bg-slate-100 text-slate-700 text-xs font-medium rounded-md hover:bg-slate-200 transition-colors">
                                                            View
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                        ...
                        <div class="bg-white border border-slate-100 rounded-md shadow-sm">
                            <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="<?php echo e(route('user.notifications')); ?>" class="text-xs font-medium text-primary hover:text-primary-dark transition-colors">View all</a>
                            ...
                            <?php if($notifications->count() > 0): ?>
                                <div class="divide-y divide-slate-100 max-h-80 overflow-y-auto" id="notifications-container">
                                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="px-5 py-3 notification-item hover:bg-slate-50 transition-colors" data-id="<?php echo e($notification->id); ?>">
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="min-w-0 flex-1">
                                                    <p class="text-sm font-medium text-slate-900 truncate"><?php echo e($notification->title); ?></p>
                                                    <p class="text-xs text-slate-500 mt-0.5 line-clamp-2"><?php echo e($notification->message); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/user/dashboard.blade.php ENDPATH**/ ?>