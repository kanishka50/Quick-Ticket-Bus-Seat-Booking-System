        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-white border border-slate-100 rounded-md shadow-sm p-6">
                    <form action="<?php echo e(route('provider.buses.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <select name="bus_type_id" id="bus_type_id"
                                    ...
                                    <?php $__currentLoopData = $busTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $busType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($busType->id); ?>" <?php echo e(old('bus_type_id') == $busType->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div id="seat-layout-builder" class="border border-slate-200 rounded-md p-4 bg-slate-50">
                                    ...
                                    <input type="hidden" name="seat_layout" id="seat-layout-json" value="<?php echo e(old('seat_layout', '[]')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="hidden" name="amenities" id="amenities-json" value="<?php echo e(old('amenities', '[]')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\bus-ticket-booking-system\resources\views/providers/buses/create.blade.php ENDPATH**/ ?>